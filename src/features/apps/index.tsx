      ...
      <Main fixed>
        <div>
          ...
          <p className='text-muted-foreground'>
            Configure and manage AI models for HVAC optimization
          </p>
        </div>
            ...
            >
              <div className='mb-8 flex items-center justify-between'>
                ...
                <Button
                  variant='outline'
                  size='sm'
                  className={`${app.connected ? 'border border-green-300 bg-green-50 hover:bg-green-100 dark:border-green-700 dark:bg-green-950 dark:hover:bg-green-900' : ''}`}
                >
