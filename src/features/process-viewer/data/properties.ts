...
import { type ProcessViewerProperty, type ProcessStatus } from './schema'
...
export const processViewerProperties: ProcessViewerProperty[] = Array.from(
  { length: 30 },
  (_, index) => {
    ...
    return {
      ...
      property: propertyNames[index % propertyNames.length],
      propertyId: `PRP-${String(index + 1).padStart(4, '0')}`,
      ...
      message: !isOnline ? faker.helpers.arrayElement([
        ...
        'Property vacated and most systems offline',
